...
class Imagemagick < Formula
  ...
  depends_on 'little-cms' if build.include? 'use-cms'
  depends_on 'jasper' if build.include? 'use-jpeg2000'
  depends_on 'libwmf' if build.include? 'use-wmf'
  depends_on 'librsvg' if build.include? 'use-rsvg'
  depends_on 'liblqr' if build.include? 'use-lqr'
  depends_on 'openexr' if build.include? 'use-exr'
